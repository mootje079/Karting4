...
class MedewerkerController extends Controller
{
    ...
    /**
     * @Route("admin/nieuwSoortActiviteit", name="nieuwSoortActiviteit")
     */
    public function nieuweSoortActiviteitToevoegenAction(Request $request)
    {
        ...
        return $this->render('medewerker/soortActiviteit.html.twig',array('boodschap'=>'Voeg een nieuwe Activiteit toe','form'=>$form->createView(),'naam'=>'toevoegen'));
    }
}
